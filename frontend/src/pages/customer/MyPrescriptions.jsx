    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Your eye power records from NetraKiran</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-400 text-sm mb-6">Visit NetraKiran for a comprehensive eye check-up</p>
