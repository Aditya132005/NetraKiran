      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="border-t border-navy-700 mt-10 pt-6 space-y-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-navy-400">
            <p>© {new Date().getFullYear()} NetraKiran. All rights reserved.</p>
          ...
          <p className="text-[10px] text-navy-500 text-center leading-relaxed max-w-4xl mx-auto">
            NetraKiran is a registered optical retail business. All product images, brand names, and trademarks belong to their respective owners and are used for identification purposes only.
            Prices are subject to change without notice. Prescriptions dispensed are based on professional examination and customer-provided information — NetraKiran is not liable for errors arising from
